...
st.set_page_config(
    page_title="Spiderboys Trading Pro v6 Live Command Center",
    page_icon="🕷️",
    layout="wide"
)
...
<div style="padding:.65rem .25rem .9rem .25rem;">
  ...
  <div style="font-size:.78rem;color:#91a9c2;margin-top:.2rem;">Live Command Center v6.0</div>
</div>
""", unsafe_allow_html=True)
...
st.sidebar.caption("Live data with safe training fallbacks.")
