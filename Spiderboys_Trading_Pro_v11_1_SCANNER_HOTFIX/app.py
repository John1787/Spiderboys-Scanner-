...
st.set_page_config(
    page_title="Spiderboys Trading Pro v11.1 Scanner Terminal",
    page_icon="🕷️",
    layout="wide"
)
...
<div style="padding:.65rem .25rem .9rem .25rem;">
  ...
  <div style="font-size:.78rem;color:#ffffff;margin-top:.2rem;">Scanner Terminal v11.1</div>
</div>
""", unsafe_allow_html=True)
    ...
    **Lesson:** {trade["lesson"]}
    ...
    try:
        ...
        event = st.dataframe(
            ...
            on_select="rerun",
            selection_mode="single-row",
            key=f"full_scanner_{scanner_name}_plain",
            column_config={
                "Price": st.column_config.NumberColumn(format="$%.2f"),
                "Volume": st.column_config.NumberColumn(format="compact"),
                "Float M": st.column_config.NumberColumn(format="%.2f"),
