...
## Version 6.2 clean-up

- Reduced the primary navigation to eight sections
- Moved specialist workspaces under More Tools
- Fixed the visible DeltaGenerator/Streamlit documentation bug
- Updated FMP news calls to the current stable endpoint structure
- Reduced news-table clutter and moved URLs/details into an expander
- Made the top banner smaller and simplified connection messaging
